...
function addTask(){
    ...
    var time=document.getElementById("f2").value+=":00Z";
...
function editTask(){
    ...
    var time=document.getElementById("i2").value+=":00Z";
    var status=document.getElementById("i3").value;
    var id=document.getElementById("SC").value;
    // editTask['expiryDate']=document.getElementById('datetime').value+":00Z";
